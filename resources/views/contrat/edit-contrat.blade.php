  ...
  <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8 items-center bg-white rounded-lg w-8/12">
    <form method="POST" action="#">
      ...
      <div class="sm:col-span-2">
          <label for="marque" class="block text-sm font-medium text-gray-700">Content *</label>
          <div class="mt-1">
              <input type="text" name="content" id="marque" autocomplete="content" class="border-2 py-3 px-4 block w-full shadow-sm border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent focus:shadow hover:border-purple-400"
                  >
          </div>
      </div>
