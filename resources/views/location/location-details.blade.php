    ...
    <div class="container mx-auto px-6">
        <div class="md:flex md:items-center">
            ...
            <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                <h3 class="text-gray-700 uppercase text-lg">Location</h3>
                <span class="text-gray-500 mt-3">{{location->vehicule_id}}</span>
                <span class="text-gray-500 mt-3">{{location->contrat_id}}</span>
                <hr class="my-3">
                {{-- <div class="mt-2">
