            ...
            <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                <h1>
                    ...
                    <span class="mt-1 block text-4xl tracking-tight font-extrabold sm:text-5xl xl:text-6xl">
                        ...
                        <span class="block text-purple-600">online business</span>
                    </span>
                </h1>
                ...
                <div class="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                    ...
                    <form action="#" method="POST" class="mt-3 sm:flex">
                        ...
                        <input type="text" name="email" id="email"
                            class="border-2 block w-full py-3 text-base rounded-md placeholder-gray-500 shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:flex-1 border-gray-300"
                            placeholder="Enter your email">
                        <button type="submit"
                            class="mt-3 w-full px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-800 shadow-sm hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:mt-0 sm:ml-3 sm:flex-shrink-0 sm:inline-flex sm:items-center sm:w-auto">
                            Notify me
                        </button>
                    </form>
                    <p class="mt-3 text-sm text-gray-500">
                        We care about the protection of your data. Read our
                        <a href="{{ url('/privacy-policy') }}" class="font-medium text-gray-900 underline">Politique de confidantialites</a>.
                    </p>
                </div>
            </div>
            <div
