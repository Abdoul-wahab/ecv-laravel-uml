...
Route::get('/contrats', [ContratController::class, 'index'])->name('index');
...
Route::get('/controles', [ControleController::class, 'index'])->name('index');
...
Route::get('/employes', [EmployeController::class, 'index'])->name('index');
...
Route::get('/vehicules', [VehiculeController::class, 'index'])->name('index');
